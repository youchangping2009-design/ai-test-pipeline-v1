...
def build_weak_cases(rows: list[dict[str, str]]) -> list[dict[str, Any]]:
    ...
    for row in rows:
        ...
        if "未发现" in expected or "一致" in expected:
...
def compute_duplicate_metrics(duplicate_report: dict[str, Any]) -> dict[str, Any]:
        ...
        warnings.append(
            {
                ...
                "artifact": "reviews/duplicate_case_report.json",
