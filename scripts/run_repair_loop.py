...
def write_human_action(task_id: str, command: list[str], expect: str, attempts: int, output: str) -> Path:
    ...
    content = (
        ...
        "Why Codex cannot decide: Automated repair either was not provided or did not make the validation command match its expected outcome within 2 repair rounds.\n"
        ...
        "Impact if unresolved: Codex will not continue blind changes for this task.\n\n"
        "## Last Output Tail\n\n"
        "```text\n"
        f"{tail}\n"
        "```\n"
