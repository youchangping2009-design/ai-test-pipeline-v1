...
```bash
python3 scripts/create_work_item.py --project-code WX-YGJ --work-item-id REQ-001
python3 scripts/validate_work_item.py --project-code WX-YGJ --work-item-id REQ-001 --strict
python3 scripts/refresh_project_views.py --project-code WX-YGJ
python3 scripts/validate_project.py --project-code WX-YGJ --strict
```
