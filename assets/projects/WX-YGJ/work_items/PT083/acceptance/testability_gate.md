...
|---|---|---|---|---|---|---|---|
| TG-001 | OBJ-001 | field_constraint | testable | generate_acceptance_example | confirmed | promotion_slogan; value_constraint | 字段必填、范围、长度、格式、数量或数据源规则具备明确可观察结果。 |
| TG-002 | OBJ-002 | field_constraint | testable | generate_acceptance_example | confirmed | performance_parameters; value_constraint | 字段必填、范围、长度、格式、数量或数据源规则具备明确可观察结果。 |
| TG-003 | OBJ-003 | field_constraint | testable | generate_acceptance_example | confirmed | 后台未配置特殊区商品时隐藏 | 字段必填、范围、长度、格式、数量或数据源规则具备明确可观察结果。 |
| TG-004 | FR-云挂机购买页-特价专区-01 | field_constraint | testable | generate_acceptance_example | confirmed | 最多展示4个商品 | 字段必填、范围、长度、格式、数量或数据源规则具备明确可观察结果。 |
...
| TG-021 | FR-盒子管理后台-云手机商品管理-添加-商品区与库存规则说明表-07 | field_constraint | testable | generate_acceptance_example | confirmed | 已有功能，增加未配置提示；服务时长结束后C端不再展示 | 字段必填、范围、长度、格式、数量或数据源规则具备明确可观察结果。 |
...
| TG-034 | FR-盒子管理后台-编辑宣传内容-宣传内容编辑表单-03 | field_constraint | testable | generate_acceptance_example | confirmed | 文本长度20个字符；C端超过一行换行展示 | 字段必填、范围、长度、格式、数量或数据源规则具备明确可观察结果。 |
| TG-035 | FR-盒子管理后台-编辑宣传内容-宣传内容编辑表单-04 | field_constraint | testable | generate_acceptance_example | confirmed | 文本长度20个字符；C端超过一行换行展示 | 字段必填、范围、长度、格式、数量或数据源规则具备明确可观察结果。 |
